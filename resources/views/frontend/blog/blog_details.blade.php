                    ...
                    <div class="col-lg-9">
                        <div class="single-page pt-50 pr-30">
                                    ...
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        ...
                                        <div class="single-header-meta">
                                            <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                                ...
                                                <span class="post-by">Por <a href="#">Administración</a></span>
                                                <span class="post-on has-dot">
                                                    {{ Carbon\Carbon::parse($blogdetails->created_at)->diffForHumans() }}
                                                </span>
                                            </div>
                                            <div class="social-icons single-share">
                                                <ul class="text-grey-5 d-inline-block">
                                                    <li class="mr-5">
                                                        <a href="#">
                                                            <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-bookmark.svg') }}" alt="" />
                                                        </a>
                                                    </li>
                            ...
                            <figure class="single-thumbnail" align="center">
                                <img src="{{ asset($blogdetails->post_image) }}" alt="" style="width: 500px;height: 300px;" />
                            </figure>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ url('post/category/'.$category->id.'/'.$category->blog_category_slug) }}"> 
                                            <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />
