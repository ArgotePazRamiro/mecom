                ...
                success: function(response) {    
                    ...
                    $.each(response.carts, function(key,value){
                        ...
                        <tr class="pt-30">
                            ...
                            <td class="product-des product-name">
                                <h6 class="mb-5">
                                    <a class="product-name mb-10 text-heading" href="shop-product-right.html">${value.name}</a>
                                </h6>
                                
                            </td>

                            <td class="price" data-title="Price">
                                <h4 class="text-body">${value.price} Bs.</h4>
                            </td>
                            ...
                            <td class="price" data-title="Price">
                                <h4 class="text-brand">${value.subtotal} Bs.</h4>
                            </td>
                            <td class="action text-center" data-title="Remove">
                    ...
                    if (data.total) {
                        ...
                        <tr>
                            ...
                            <td class="cart_total_amount">
                                <h4 class="text-brand text-end">${data.total} Bs.</h4>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="cart_total_amount">
                                <h4 class="text-brand text-end">${data.subtotal} Bs.</h4>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="cart_total_label">
                                <h6 class="text-muted">Importe de Descuento</h6>
                            </td>
                            <td class="cart_total_amount">
                                <h4 class="text-brand text-end">${data.discount_amount} Bs.</h4>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="cart_total_amount">
                                <h4 class="text-brand text-end">${data.total_amount} Bs.</h4>
                            </td>
                        </tr>
