                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="clearfix product-price-cover">
                                ...
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand">Bs. {{ $product->selling_price }}</span>
                                </div>
                                @else
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand">Bs. {{ $product->discount_price }}</span>
                                    <span>
                                        <span class="save-price font-md color3 ml-15">{{ round($discount) }}% de Descuento</span>
                                        <span class="old-price font-md ml-15">Bs. {{ $product->selling_price }}</span>
                                    </span>
                                </div>
                                @endif
