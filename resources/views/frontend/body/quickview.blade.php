                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h5 class="title-detail">
                                    <a href="" class="text-heading" id="pname"></a>
                                </h5>
                                <br>

                                <div class="attr-detail attr-size mb-30" id="sizeArea">

                                    <strong class="mr-10" style="width:60px">Tamaño: </strong>
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand" id="pprice">Bs.</span>
                                        <span>
                                            <span class="old-price font-md ml-15" id="oldprice">Bs.</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="detail-extralink mb-30">
                                    ...
                                    <div class="product-extra-link2">
                                        <button type="submit" class="button button-add-to-cart" onclick="addToCart()"><i class="fi-rs-shopping-cart"></i>
                                            Añadir al Carrito
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="font-xs">
                                            <ul>
                                                <li class="mb-5">Marca: 
                                                    <span class="text-brand" id="pbrand"></span>
                                                </li>
                                                <li class="mb-5">Categoría:
                                                    <span class="text-brand" id="pcategory"></span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="font-xs">
                                            <ul>
                                                <li class="mb-5">Código: 
                                                    <span class="text-brand" id="pcode"></span>
                                                </li>
                                                <li class="mb-5">Stock:
