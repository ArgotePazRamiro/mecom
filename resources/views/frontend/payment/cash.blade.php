...
<div class="container mb-80 mt-50">
    <div class="row">
        <div class="col-lg-8 mb-40">
            <h3 class="heading-2 mb-10">Pago en Efectivo al Entregar</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="border p-40 cart-totals ml-30 mb-50">
                <div class="d-flex align-items-end justify-content-between mb-30">
                    <h4>Realizar Pago en Efectivo</h4>
...
var stripe = Stripe('pk_test_51MOUXBG9v7U7ZOKeq8kdQzydFxIdroh8mfZFe0CJxGU3FjD3qS7QhYsXYyQd4vEpNIROK1GOxvVywoGhbXz8jc9Q00vgFYPLTu');
