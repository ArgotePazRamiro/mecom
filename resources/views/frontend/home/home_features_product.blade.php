            ...
            <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                <div class="banner-img style-2">
                    <div class="banner-text">
                        <h2 class="mb-100">Visítanos y Descubre Nuevos Límites</h2>
                        <a href="https://latam.msi.com/" target="_blank" class="btn btn-xs">Continuar<i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
