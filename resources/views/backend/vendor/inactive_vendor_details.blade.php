...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Detalles de Vendedor Inactivo</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Detalles de Vendedor Inactivo</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('active.vendor.approve') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Nombre de Tienda</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Email de Vendedor</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Teléfono de Vendedor</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Dirección de Vendedor</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Fecha de Unión</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Información de Vendedor</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <textarea name="vendor_short_info" class="form-control" id="inputAddress2" placeholder="Descripción" rows="3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Foto de Vendedor</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-danger px-4" value="Activar Vendedor" />
                                    </div>
                                </div>
                        </div>
