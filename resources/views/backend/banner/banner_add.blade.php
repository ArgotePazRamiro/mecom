...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Añadir Banner</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Añadir Banner</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('store.banner') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Título de Banner</h6>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">URL de Banner</h6>
                                    </div>
                                    <div class="form-group col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Imagen de Banner</h6>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages: {
                banner_title:{
                    required: 'Por favor Ingrese el Título del Banner',
                },
                banner_url:{
                    required: 'Por favor Ingrese el URL del Banner',
                },
            },
            errorElement: 'span',
