        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name">Mensaje<span class="msg-time float-end">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span></span>
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.change.password') }}"><i
                                class="bx bx-cog"></i><span>Cambiar Contraseña</span></a>
                    </li>
                    <li>
