...
<head>
    <meta charset="utf-8" />
    <title>Página Registro de Vendedor</title>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Hacerse Vendedor</h1>
                                            <p class="mb-30">Ya tiene una cuenta como Vendedor? <a href="{{ route('vendor.login') }}">Inicie Sesión</a></p>
                                        </div>
                                        ...
                                        <form method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="name" required="" name="name" placeholder="Nombre de Tienda" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="username" required="" name="username" placeholder="Nombre de Usuario" />
                                            </div>
                                            <div class="form-group">
                                                <input type="email" id="email" required="" name="email" placeholder="Correo Electrónico" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="phone" required="" name="phone" placeholder="Teléfono" />
                                            </div>

                                            <div class="form-group">
                                                <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
                                                    <option selected="">Seleccione Año de Inicio en Plataforma</option>
